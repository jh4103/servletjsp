    ...
    <hr />
      <form method="post" action="ParamController" novalidate>
         ...
         <div class="form-group">
            ...
            <div class="form-check-inline">
               <label class="form-check-label"> 
                  <input type="radio" class="form-check-input" name="job" value="dsigner"> 디자이너
               </label>
            </div>
      ...
      <form method="post" enctype="multipart/form-data" action="FileUploadController">
		 ...
		 <div class="form-group">
			...
			<!--multiple쓰면 다중선택이 가능함  컨트롤키 누르면 가능-->
         ...
         <button type="submit" class="btn btn-danger">Post 방식/멀티파트로 전달</button>
	  </form>
