...
@WebServlet(name="exam03.ContentController", urlPatterns="/exam03/ContentController", loadOnStartup=1)
public class ContentController extends HttpServlet{
	private String encoding;
	private String viewLocation;
	
	//클라이언트에서 최초로 서블릿을 요청 했을 때 딱 한번 실행(load-on-startup 옵션이 없을 경우)
